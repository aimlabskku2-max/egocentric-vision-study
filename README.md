...
- video: 드라이브에 올린 영상은 `{ "type": "drive", "url": "https://drive.google.com/file/d/파일ID/view" }` (클릭 시 재생, 다운로드 버튼 제공). 줌 클라우드 녹화는 `{ "type": "zoom", "url": "...", "password": "..." }` — 사이트에 암호가 표시되고 링크/암호 복사 버튼이 붙습니다. 없으면 `null`.
